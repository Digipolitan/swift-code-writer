# Contributing to swift-code-writer
...
* **Did the problem start happening recently** (e.g. after updating to a new version of swift-code-writer) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of swift-code-writer ?** What's the most recent version in which the problem doesn't happen? You can download older versions of swift-code-writer from [the releases page](https://github.com/digipolitan/swift-code-writer/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of swift-code-writer are you using?
...
#### Template For Submitting Bug Reports
    ...
    **swift-code-writer version:** [Enter swift-code-writer version here]
    ...
    * Problem started happening recently, didn't happen in an older version of swift-code-writer: [Yes/No]
